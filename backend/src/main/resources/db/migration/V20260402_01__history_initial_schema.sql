-- Initial schema for history module.
-- Keep this migration idempotent for environments where partial tables already exist.
...
CREATE INDEX idx_history_event_country_year
    ON history_event (country_id, start_year, id);
...
CREATE INDEX idx_hpbc_country_bucket
    ON history_philosophy_bucket_cache (country_id, bucket_start_year, bucket_end_year);
