...
class CsvExportEmailServiceTest {
    ...
    void sendCsvExportToEmailReusesSharedCsvAttachmentGeneration() {
        ...
        CsvExportEmailService.CsvExportAttachment attachment = csvExportEmailService.sendCsvExportToEmail(
            "admin@example.com",
            "哲学网站数据导出",
            "<p>请查收附件</p>"
        );
        ...
        assertEquals(filenameCaptor.getValue(), attachment.filename());
